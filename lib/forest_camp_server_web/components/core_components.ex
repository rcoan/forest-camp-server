defmodule ForestCampServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ForestCampServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ForestCampServerWeb.Gettext, "errors", msg, opts)
    end
  end
